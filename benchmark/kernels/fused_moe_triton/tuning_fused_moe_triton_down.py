...
def main(args: argparse.Namespace):
    ...
    if args.tune:
        ...
        filename_up = get_filename(..., down_moe=False)
        filename_down = get_filename(..., down_moe=True)
        save_configs(best_configs, filename_up)
        save_configs(best_configs, filename_down)
